test = "          #         #         #      #  #      #  #      #  #     ##  #     ##  #     ## ##     ## #####  ########  ######### ######### ######### ######### ########## #### # # # # ##### ###   ########"
print("This script tests a file you have generated named tetrisout.txt, and is paired with a solution file I have provided named tetrisout1.txt, and tests the following board:")
print("=======================")
