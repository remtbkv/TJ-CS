...
p2 = "oth_canonical_script_stability.py"
p1 = "oth_greedy_unpredictable_import.py"
#p1 = "1 van Rheenen Anthony RedOthello - Anthony Van Rheenen (Student) (1).py"
#p2 = "oth_corners_unpredictable_import.py"
players = [p1, p2]
